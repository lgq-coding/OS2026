...
本实验由刘国全、刘爽、王乐妍共同完成。分工如下：

| 成员 | 负责的练习/模块 |
|------|----------------|
| 刘国全、刘爽、王乐妍 | 共同参与实验环境配置、源码阅读、练习 1、GDB 调试与练习 2、测试截图、实验报告撰写与 Prompt 汇总 |
...
| 成员 | AI 编程工具 | 底层模型 | 备注 |
|------|------------|---------|------|
| 刘国全、刘爽、王乐妍 | Codex（VS Code/终端 Agent） | DeepSeek Flash（`deepseek-flash`） | 小组用于读取代码、分析启动流程、辅助调试和检查环境 |
